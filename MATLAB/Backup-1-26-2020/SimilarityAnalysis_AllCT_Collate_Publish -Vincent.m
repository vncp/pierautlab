...
%ANCOVA separate lines (home-made). Ctrl: c = 1 ; Other: c = 2
    [EST_NDP_gzn{b}, pF_NDP(b), Fstat_NDP(b)] =  PolFitandFtest (Npol, StimPairAll_NDP{1}{b}, OutPairAll_NDP{1}{b}, StimPairAll_NDP{2}{b}, OutPairAll_NDP{2}{b}, 0);
    [EST_SF_gzn{b}, pF_SF(b), Fsat_SF(b)] = PolFitandFtest (Npol, StimPairAll_SF{1}{b}, OutPairAll_SF{1}{b}, StimPairAll_SF{2}{b}, OutPairAll_SF{2}{b},  0);
    [EST_R_gzn{b}, pF_R(b), Fstat_R(b)] = PolFitandFtest (Npol, StimPairAll_R{1}{b}, OutPairAll_R{1}{b}, StimPairAll_R{2}{b}, OutPairAll_R{2}{b}, 0);
    ...
    subplot(3,length(tau),b) 
        ...
        ylabel('pw Sout')
        set(gca, 'xlim', [0 1], 'ylim', [0 1])
        title(['R ' num2str(Xbinsize(okb)) 'ms, p = ' num2str(pF_R(b))])
...
%NDP
    subplot(3,length(tau),b+3) 
        ...
        ylabel('pw Sout')
        set(gca, 'xlim', [0 1], 'ylim', [0 1])
        title(['NDP ' num2str(Xbinsize(okb)) 'ms, p = ' num2str(pF_R(b))])
...
% SF
    subplot(3,length(tau),b+6) 
        ...
        title(['SF ' num2str(Xbinsize(okb)) 'ms, p = ' num2str(pF_R(b))])
end
